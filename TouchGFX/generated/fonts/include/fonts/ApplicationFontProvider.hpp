...
{
    static const touchgfx::FontId DEFAULT = 0; // Inkfree_40_4bpp
    static const touchgfx::FontId LARGE = 0;   // Inkfree_40_4bpp
    static const touchgfx::FontId SMALL = 1;   // Inkfree_25_4bpp
